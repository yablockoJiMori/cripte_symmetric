...
def GOSTf():
    ...
    gostfW=Tk()
    gostfW.geometry("600x295+393+238")
    gostfW.minsize(120, 1)
    gostfW.maxsize(1444, 941)
    gostfW.resizable(1, 1)
    gostfW.title("GOST")
    gostfW.configure(background="#e6fdff")
    ...
    openB = Button(gostfW, command=openF)
    ...
    genKeyB = Button(gostfW, command=RandomKey)
    ...
    genIvB = Button(gostfW, command=RandomIV)
    ...
    TCombobox1 = ttk.Combobox(gostfW)
    ...
    encB = Button(gostfW, command=ButEnc)
    ...
    decB = Button(gostfW, command=ButDec)
    ...
    keyFile_in = Button(gostfW, command=openKey)
    ...
    keyFile_out = Button(gostfW, command=saveKey)
    ...
    ivFile_in = Button(gostfW, command=openIV)
    ...
    ivFile_out = Button(gostfW, command=saveIV)
